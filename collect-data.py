...
while True:
    ...
    cv2.putText(frame, "IMAGE COUNT", (10,75 ), cv2.FONT_HERSHEY_PLAIN, 1, (0,255,255), 1)
...
#    roi = cv2.resize(roi, (64, 64))
    ...
    #ret, test_image = cv2.threshold(roi, minValue, 255, cv2.THRESH_BINARY_INV+cv2.THRESH_OTSU)
